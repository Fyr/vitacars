...
class PCArticleComponent extends Component {
	...
	public function edit($id = 0, $lSaved = false) {
		$aFlags = array('published', 'featured', 'active', 'show_detailnum', 'load_counters', 'view_brands', 'gpz_fullinfo', 'orders', 'paid'); // можно перечислять любые поля, даже с других моделей
